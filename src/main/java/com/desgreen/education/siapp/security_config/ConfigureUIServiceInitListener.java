...
//		if (event.getNavigationTarget().equals(InternalServerError.class)) accessGranted=true;

//		System.out.println("Accesing View: " +
//				event.getNavigationTarget().getName() + " and granted is " + accessGranted);
