...
public class PeriodeController implements PeriodeListener {

    protected PeriodeModel model;
    protected PeriodeView view;

    @Autowired
    public PeriodeController(PeriodeModel model, PeriodeView view){
//        this.model = new PeriodeModel();
    ...
    public void aksiBtnNewForm() {
        view.grid.deselectAll();
        view.currentDomain = new FPeriode();
...
//            viewLogic.deleteProduct(currentProduct);
        model.fPeriodeJPARepository.delete(view.currentDomain);
    ...
    public void aksiBtnSaveForm() {
        ...
        if (view.currentDomain != null
            ...
            view.currentDomain = model.fPeriodeJPARepository.save(view.currentDomain);
