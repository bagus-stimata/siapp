...
public class MatPelController implements MatPelListener {

    protected MatPelModel model;
    protected MatPelView view;

    @Autowired
    public MatPelController(MatPelModel model, MatPelView view){
//        this.model = new MatPelModel();
    ...
    public void aksiBtnNewForm() {
        view.grid.deselectAll();
        view.currentDomain = new FMatPel();
...
//            viewLogic.deleteProduct(currentProduct);
        model.fMatPelJPARepository.delete(view.currentDomain);
    ...
    public void aksiBtnSaveForm() {
        ...
        if (view.currentDomain != null
            ...
            view.currentDomain = model.fMatPelJPARepository.save(view.currentDomain);
