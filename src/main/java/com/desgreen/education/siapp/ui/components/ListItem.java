...
import com.desgreen.education.siapp.ui.layout.size.Wide;
...
public class ListItem extends FlexBoxLayout {
	...
	public ListItem(String primary, String secondary) {
		...
		//### BIAR BOLD
//		this.primary.addClassName(LumoStyles.Heading.H5);
//		this.primary.addClassName(LumoStyles.FontFamily.MONOSPACE);
