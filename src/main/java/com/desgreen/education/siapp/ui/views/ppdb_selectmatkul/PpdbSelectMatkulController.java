...
public class PpdbSelectMatkulController implements PpdbSelectMatkulListener {

    protected PpdbSelectMatkulModel model;
    protected PpdbSelectMatkulView view;

    @Autowired
    public PpdbSelectMatkulController(PpdbSelectMatkulModel model, PpdbSelectMatkulView view){
