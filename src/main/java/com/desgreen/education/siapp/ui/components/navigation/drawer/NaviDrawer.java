...
public class NaviDrawer extends Div
	...
	private BrandExpression defaBrandExpression = new BrandExpression("SIAPP");
	private void initHeader() {
//		mainContent.add(new BrandExpression("SIAPP"));
		mainContent.add(defaBrandExpression);
	}
	public void initHeaderChange(BrandExpression brandExpression){
		mainContent.remove(defaBrandExpression);
		mainContent.addComponentAsFirst(brandExpression);
